...
#         ./configure --prefix="${PREFIX}" --with-ogg="${PREFIX}" --disable-shared && \
#         make && \
#         make install && \
#         rm -rf ${DIR}
...
#         ./configure --prefix="${PREFIX}" --bindir="${PREFIX}/bin" --datadir="${DIR}" --disable-shared && \
#         make && \
#         make install && \
#         rm -rf ${DIR}
...
# COPY . /tmp/ffmpeg
RUN \
        DIR=/tmp/ffmpeg && mkdir -p ${DIR} && \
        git clone https://github.com/ngotchac/FFmpeg.git ${DIR} && \
        cd ${DIR} && git checkout ts-offset
